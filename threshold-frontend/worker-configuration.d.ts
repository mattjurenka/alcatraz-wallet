/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 80f7b5a803dccefee96e3853b4152127)
...
declare namespace Cloudflare {
	...
	interface Env {
		THRESHOLD: KVNamespace;
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		BLOCKVISION_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "BLOCKVISION_KEY">> {}
}
