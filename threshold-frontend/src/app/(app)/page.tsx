...
export default function Home() {
	...
	return (
		<div className="px-2 sm:px-4 lg:px-[30%] h-full flex grow flex-col pt-4">
			{multisigs.length > 0 ?
			 	<div className="flex flex-col gap-4">
					<h2 className="text-lg font-semibold">Loaded Multisigs</h2>
					{multisigs.map(multisig => <Link href={"/" + multisig.address} id={multisig.address} className="rounded-md border border-black py-2 px-2 sm:px-4 text-left shadow-md flex">
